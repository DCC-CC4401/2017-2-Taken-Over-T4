    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.SmallIntegerField(choices=[(1, 'Abandono en la calle'), (2, 'Exposicion a temperaturas<br>extremas'), (3, 'Falta de agua'), (4, 'Falta de comida'), (5, 'Violencia'), (6, 'Venta ambulante')])),
